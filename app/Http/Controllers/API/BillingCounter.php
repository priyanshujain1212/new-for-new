...
class BillingCounter extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $data['action_key'] = 'A_VIEW_PARTICULAR_LISTING';
            ...
            foreach($billing_counters as $key => $billing_counter){
                ...
                $item_array[$key][] = $billing_counter['particular_to'];
    ...
    public function store(Request $request)
    {
        try {
            ...
            if(!check_access(['A_ADD_PARTICULAR'], true)){
            ...
            $billing_counter = [
                ...
                "billing_counter_code" => mt_rand(100,999),
                "particular_to" =>$request->particular_to,
    ...
    { 
        try {
            ...
            if(!check_access(['A_DETAIL_PARTICULAR'], true)){
                throw new Exception("Invalid request", 400);
            }
    ...
    public function list(Request $request)
    {
        try {
            ...
            if(!check_access(['A_VIEW_PARTICULAR_LISTING'], true)){
                throw new Exception("Invalid request", 400);
            }
    ...
    public function update(Request $request, $slack)
    {
        try {
            ...
            if(!check_access(['A_EDIT_PARTICULAR'], true)){
                throw new Exception("Invalid request", 400);
            }
