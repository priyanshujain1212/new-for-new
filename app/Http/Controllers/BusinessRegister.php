...
class BusinessRegister extends Controller
{
    ...
    public function add_business_register(){
        ...
        $data['particulars'] = $this->get_free_billing_counters();
    ...
    public function get_free_billing_counters(){
        ...
        $particulars = BillingCounterModel::select('id', 'billing_counters.slack', 'billing_counter_code', 'counter_name')
        ->active()
        ->get();

        foreach($particulars as $billing_counter){
