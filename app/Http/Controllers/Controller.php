...
class Controller extends BaseController
{
    ...
    */
    ...
    {
        session()->put('fullname', $customer->fullname);
        session()->put('firstname', $customer->firstname);
        session()->put('profile_image', $customer->profile_image);
        session()->put('slack', $customer->slack);
        session()->put('user_id', $customer->id);
        session()->put('role', $customer->role_id);    
        session()->put('initial_link', $customer->initial_link);     
        session()->put('access_token', $token);
        //Session::save();
    }
