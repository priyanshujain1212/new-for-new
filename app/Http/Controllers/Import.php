...
class Import extends Controller
{
    public function index(Request $request)
    {
        ...
        if(check_access(['A_UPLOAD_CUSTOMER'], true)){
            $options[] = [ 'key' => 'CUSTOMER', 'value' => 'customers'];
            $format_file = Config::get('constants.upload.imports.customer_format');
            $templates[] = ['template_link' =>  asset($format_file), 'template_label' => 'Customer'];
        }
