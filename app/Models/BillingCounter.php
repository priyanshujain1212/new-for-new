...
class BillingCounter extends Model
{
    ...
    protected $fillable = ['slack', 'store_id', 'billing_counter_code','particular_to', 'store_slack','counter_name', 'description', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'];
