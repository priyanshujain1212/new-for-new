...
class PurchaseOrderProduct extends Model
{
    ...
    protected $fillable = ['slack', 'purchase_order_id', 'product_id', 'product_slack', 'product_code', 'name', 'total_amount', 'stock_update', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'];

    public function scopeProduct($query){
        return $query->leftJoin('particulars', function ($join) {
            $join->on('particulars.id', '=', 'purchase_order_products.product_id');
        });
    }
