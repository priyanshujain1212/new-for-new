<template>
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-left store-selector-dropdown" aria-labelledby="user_store_dropdown">
            ...
            <a class="dropdown-item mb-2" href="#" v-for="(store, index) in stores" v-bind:value="store.store_slack" v-bind:key="index" v-on:click="seltrust(store.store_slack)" v-bind:class="{'border-left border-primary bg-light': store.store_slack == selected_store.store_slack}">
