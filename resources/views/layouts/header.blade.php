...
<head>
    ...
    <script>
        ...
        window.settings = {
            ...
            logged_user_code: "{{ isset($logged_user_data['user_code']) ? $logged_user_data['user_code'] : '' }}",
            logged_customer_code: "{{ isset($logged_customer_data['customer_code']) ? $logged_customer_data['customer_code'] : '' }}",
    ...
    <title>{{ config('app.app_title', 'Appsthing POS ') }}</title>
</head>
