...
Route::group(['middleware' => ['app_indicator', 'token_auth', 'user_menu']], function () {
    ...
    Route::get('/phonepe/{slack}', "Payment@phonepe")->name('phonepe');
    Route::any('/phonepe-response', "Payment@response")->name('response');
...
// routes/web.php
    ...
    Route::get('/export-customers', "Customer@exportCustomers")->name('export-customers');
    ...
    //store
    Route::get('/trusts', "Store@index")->name('trusts');
    Route::get('/store/{slack}', "Store@detail")->name('store');
    Route::get('/addtrust', "Store@addtrust")->name('addtrust');
    Route::get('/edittrust/{slack?}', "Store@addtrust")->name('edittrust');
    Route::get('/seltrust', "Store@seltrust")->name('seltrust');
    ...
    Route::get('/rasid_detail/{slack}', "PurchaseOrder@detail")->name('rasid_detail');
    Route::get('/addrasid', "PurchaseOrder@addrasid")->name('addrasid');
    Route::get('/editrasid/{slack?}', "PurchaseOrder@addrasid")->name('editrasid');
    ...
    //billing counter
    Route::get('/particulars', "BillingCounter@index")->name('particulars');
    Route::get('/billing_counter/{slack}', "BillingCounter@detail")->name('billing_counter');
    Route::get('/addparticular', "BillingCounter@addparticular")->name('addparticular');
    Route::get('/edit_billing_counter/{slack?}', "BillingCounter@addparticular")->name('edit_billing_counter');
...
Route::get('/payment/success/{slack}',  'Payment@success')->name('payment.success');
Route::get('/payment/failure/{slack}',  'Payment@failure')->name('payment.failure');


Route::get('/payment/{slack}', 'Payment@phonepePayment')->name('payment');
Route::post('/payment_callback/{slack}', 'Payment@paymentCallback')->name('payment.callback');


Route::post('/google-pay-payment', 'GooglePayController@handleGooglePayPayment')->name('handleGooglePayPayment');
